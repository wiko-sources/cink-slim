...
void fiq_uart_fixup(int uart_port)
{
    ...
    case 0:
        ...
        fiq_resource[1].start = MT6577_UART1_IRQ_ID;
        fiq_resource[1].end = MT6577_UART1_IRQ_ID;
        uart_irq_number = MT6577_UART1_IRQ_ID;
        break;
    case 1:
        console_base_addr = UART2_BASE;
        fiq_resource[1].start = MT6577_UART2_IRQ_ID;
        fiq_resource[1].end = MT6577_UART2_IRQ_ID;
        uart_irq_number = MT6577_UART2_IRQ_ID;
        break;
    case 2:
        console_base_addr = UART3_BASE;
        fiq_resource[1].start = MT6577_UART3_IRQ_ID;
        fiq_resource[1].end = MT6577_UART3_IRQ_ID;
        uart_irq_number = MT6577_UART3_IRQ_ID;
        break;
    case 3:
        console_base_addr = UART4_BASE;
        fiq_resource[1].start = MT6577_UART4_IRQ_ID;
        fiq_resource[1].end = MT6577_UART4_IRQ_ID;
        uart_irq_number = MT6577_UART4_IRQ_ID;
        break;
    default:
        break;
    }
